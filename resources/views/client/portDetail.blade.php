...
@section('meta')
    ...
    <!--<meta itemprop="publisher" content="Animals Nature Press"/>-->
            ...
            <div class="row">
                ...
                <div class="col-sm-8">
                    ...
                    <div class="text-right">
                        <a id="btnCoppy" style="margin-top: -8px; line-height: 1.3 !important;color: white"
                            target="blank"
                        ...
                        <button id="btnCoppy" style="margin-top: -7px" class="btn btn-sm btn-primary"
                            title="Coppy link" onclick="copyText()"><i class="fa fa-copy"></i></button>
                    </div>
